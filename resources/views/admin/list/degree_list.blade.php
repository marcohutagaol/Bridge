        ...
        <div class="mt-4">
            <nav aria-label="Page navigation">
                <ul class="pagination justify-content-center">
                    <li class="page-item {{ $degrees->onFirstPage() ? 'disabled' : '' }}">
                        <a class="page-link" href="{{ $degrees->previousPageUrl() }}">
                            <span aria-hidden="true">&laquo;</span> Previous
                        </a>
                    </li>

                    @for ($i = 1; $i <= $degrees->lastPage(); $i++)
                        <li class="page-item {{ $degrees->currentPage() == $i ? 'active' : '' }}">
                            <a class="page-link" href="{{ $degrees->url($i) }}">{{ $i }}</a>
                        </li>
                    @endfor

                    <li class="page-item {{ $degrees->hasMorePages() ? '' : 'disabled' }}">
                        <a class="page-link" href="{{ $degrees->nextPageUrl() }}">
