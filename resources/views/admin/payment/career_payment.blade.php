...
@section('content')
  <div class="career-purchases-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h1 class="page-title">Career Purchases List</h1>
    </div>
      ...
      <div class="filter-section">
        ...
        <div class="filter-actions">
          <div class="button-group">
            ...
            <a href="{{ route('admin.payment.career_payment') }}" class="btn btn-secondary">Reset</a>
          </div>
        ...
        <table class="data-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <span class="career-name">{{ $checkout->career->name }}</span>
              </td>
              <td>
  ...
  <style>
    ...
    .data-table tbody tr:hover .career-name {
      color: #8b5cf6;
    }
